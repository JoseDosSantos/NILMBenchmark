...
parser.add_argument("--appliance_name", type=remove_space, default=appliance, help="The name of the appliance to perform disaggregation with. Default is kettle. Available are: kettle, fridge, dishwasher, microwave. ")
...
saved_model_dir = f"saved_models/{arguments.appliance_name}_{arguments.interval}_{arguments.network_type}_model.h5"

# The logs including results will be recorded to this log file
log_file_dir = f"saved_models/{arguments.appliance_name}_{arguments.interval}_{arguments.network_type}.log"
